---
title: Workflow: from first frame to video
description: The recommended path for video generation on PornX.
---
...
Open the image generator and select the **Realism** model. Realism is currently the only model that supports image-to-video.

Compose the shot with animation in mind:
...
- **Lighting** — flat or soft lighting is more stable across frames than hard dramatic shadows
...
Choose **Image-to-Video** and upload or select your first frame from the gallery.
