...
Generate an image using Realism, then animate it. This gives you control over the first frame before committing to a video generation. Realism is currently the only model that supports image-to-video. Maximum duration is five seconds.
