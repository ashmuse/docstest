---
title: "Quickstart: generate your first AI image"
description: "Follow this step-by-step quickstart to generate your first AI image on PornX in under a minute using a text prompt, model, and settings."
...
<Tabs>
  <Tab title="PC">
    <Frame>
      ![Uintroduction Pcui 1](/images/uintroduction_pcui-1.png)
    </Frame>
  </Tab>
  <Tab title="Mobile">
    <Frame>
      ![Introduction Mobileui](/images/introduction_mobileui.png)
    </Frame>
  </Tab>
</Tabs>
